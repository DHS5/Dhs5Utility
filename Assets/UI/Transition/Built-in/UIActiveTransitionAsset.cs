...
{
    [CreateAssetMenu(menuName = "Dhs5 Utility/UI/Transition Asset/Active")]
    public class UIActiveTransitionAsset : UIGenericTransitionAsset<bool, UITransitionPreset<bool>>
    {
        #region Apply
