...
{
    [CreateAssetMenu(menuName = "Dhs5 Utility/UI/Transition Asset/Sprite")]
    public class UISpriteTransitionAsset : UIGenericTransitionAsset<Sprite, UITransitionPreset<Sprite>>
    {
        #region Apply
